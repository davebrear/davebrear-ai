...
atoms:
  ...
  - "[[the-storage-unit-metaphor]]"
  - "[[the-invisible-arrangement]]"
  - "[[model-portability]]"
  - "[[vendor-memory-is-renting-furnished]]"
  - "[[the-context-layer]]"
  - "[[context-is-the-differentiator]]"
  - "[[local-model-beats-frontier-without-context]]"
  - "[[context-aware-routing]]"
  - "[[the-workflow-package]]"
  - "[[markdown-as-universal-format]]"
  - "[[compound-interest-on-thinking]]"
  - "[[four-modalities-of-search]]"
tags:
  - ai
  - enterprise
...
But storing context isn't enough. It needs to be intelligently referenceable. I've written before about the four modalities of knowledge retrieval: keyword search finds what you said, metadata finds what you filed, graph traversal finds what you connected, and semantic search finds what you meant.
